...
public class SpatialiteTest {
    ...
    public void setUp() {
        ...
        mDatabase.execSQL("SELECT InitSpatialMetaData()");
    ...
    private int getInt(String query) {
        try (Cursor c = mDatabase.rawQuery(query, new String[]{})) {
    ...
    public void testVersion_Spatialite() {
        assertEquals("5.1.0", getString("SELECT spatialite_version()"));
    }

    @SmallTest
    @Test
    public void testVersion_Proj4() {
        assertEquals("Rel. 9.2.1, June 1st, 2023", getString("SELECT proj4_version()"));
    }

    @SmallTest
    @Test
    public void testVersion_GEOS() {
        assertEquals("3.12.0-CAPI-1.18.0", getString("SELECT geos_version()"));
    }
    ...
    @Ignore("I have removed LibXML2 myself")
    @SmallTest
    @Test
    ...
    @Ignore("I have removed free excel support myself")
    @SmallTest
    @Test
    ...
    public void testNestedFunctions() {
        ...
        Cursor c = mDatabase.rawQuery("select intersection(geometry, (select geometry from ln_data where id=62175)) as textintersection from ln_data", new String[] {});
