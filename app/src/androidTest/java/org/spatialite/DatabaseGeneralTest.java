...
public class DatabaseGeneralTest /*implements PerformanceTestCase*/ {
    ...
    static  long computedResult=-1;
    @MediumTest
    @Test
    public void testCustomFunction() {

        /*
            Iulian: in the official sqllite bindings https://sqlite.org/android/tree?type=tree
            the custom function does not return a value and its callback has return type void
            more in the official jni binding file lib/src/main/jni/android_database_SQLiteConnection.cpp:271
            it says TODO: Support functions that return values.
            I have modified this test accordingly
        ...
        mDatabase.addCustomFunction("roundFunction", 1, new SQLiteDatabase.CustomFunction() {
            ...
            public void callback(String[] args) {
                ...
                computedResult=Math.round(value);
            }
        });
        mDatabase.execSQL("SELECT roundFunction(3.14)");
        assertSame(3L, computedResult);
    }
